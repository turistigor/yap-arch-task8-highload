...
Проект архитектуры предполагает выполнение [требований](../README.md#требования) и решение [проблем](../README.md#проблемы).
...
**На текущий момент выбран центрального узла - Москва.**
...
- производительности за счет выбора:
    - самого близкого ЦОДа;
...
С учетом требований и приоритетов:
- одинаковое время загрузки страниц для пользователей из разных регионов,
...
Шардирование избыточно для тех объемов данных, которые сейчас имеет компания.  
...
- 390 мс для синхронной (в худшем случае).

С учетом возможности параллельной отправки запросов, цифры задержки позволяют уложиться в требование: "запросы оформления — 10 RPS". Но выберем все же асинхронную репликацию для экономии времени.
