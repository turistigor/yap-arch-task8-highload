...
4. Получение/сохранение информации о клиентах (фронтенд -> client-info)
    - Стандартный синхронный запрос от frontend к backend с выборкой данных из БД => не видно проблем.
...
- добавление в систему брокера сообщений (Kafka, Artemis или аналог) и логики работы с ним;
- реализацию Transactional Outbox для создания/изменения пользователя:
    - создать Outbox table в ins-comp-settlement-db (в схеме данных client-info),
...
- Утечки и повреждения кэширования данных:
    ...
    - тщательное тестирование работы с данными, чтобы один пользователь не оплатил страховку другому;
